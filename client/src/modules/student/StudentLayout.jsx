...
import { 
  ...
  Compass, Menu, Settings, Sun, Moon, Sparkles, CheckCircle2, Info
} from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen bg-[#f8fafc] dark:bg-[#020617] font-sans transition-colors duration-300 selection:bg-sky-500/30">
      ...
      <aside className="w-64 bg-white dark:bg-[#0a0f1c] text-slate-900 dark:text-white hidden md:flex flex-col fixed h-full z-30 border-r border-slate-200 dark:border-slate-800/50 shadow-sm dark:shadow-2xl transition-colors duration-300">
        <div className="h-24 flex items-center px-8 border-b border-slate-100 dark:border-slate-800/50 bg-white dark:bg-[#0a0f1c] z-10 transition-colors duration-300">
          <Link to="/student/dashboard" className="text-2xl font-black flex items-center gap-2 tracking-tight group">
            ...
            <span className="text-slate-900 dark:text-white">Learn<span className="text-sky-500">Hub</span></span>
          </Link>
        </div>

        <nav className="flex-1 p-5 space-y-2 mt-4 overflow-y-auto custom-scrollbar">
          <p className="px-4 text-[10px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-[0.2em] mb-4">Learning OS</p>
          ...
          <p className="px-4 text-[10px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-[0.2em] mb-4 mt-8">Account</p>
        ...
        <div className="p-5 border-t border-slate-100 dark:border-slate-800/50 bg-white dark:bg-[#0a0f1c] transition-colors duration-300">
          <button onClick={handleLogout} className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 w-full rounded-2xl text-xs font-black uppercase tracking-widest transition-all group">
        ...
        <header className="h-24 bg-white/80 dark:bg-[#020617]/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800/50 flex justify-between md:justify-end items-center px-8 sticky top-0 z-20 transition-colors duration-300">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4 pl-6 border-l border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 p-2 pr-4 rounded-full transition-colors cursor-pointer group">
              ...
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-sky-400 to-indigo-600 text-white flex items-center justify-center font-black text-lg border-2 border-white dark:border-slate-800 shadow-lg group-hover:scale-105 transition-transform overflow-hidden">
                {user?.profilePic ? (
