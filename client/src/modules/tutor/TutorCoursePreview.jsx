          ...
          <div className="overflow-y-auto flex-1 p-4 space-y-2 custom-scrollbar">
            {course.lessons?.map((lesson, index) => {
              ...
              return (
                ...
                >
                  <div className={`mt-1 font-black text-xs transition-colors ${isActive ? 'text-indigo-400' : 'text-slate-700 group-hover:text-slate-500'}`}>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      <span className={`text-[8px] font-black uppercase px-2 py-0.5 rounded tracking-[0.15em] border ${lesson.type === 'quiz' ? 'bg-orange-500/10 border-orange-500/30 text-orange-400' : 'bg-indigo-500/10 border-indigo-500/30 text-indigo-400'}`}>
