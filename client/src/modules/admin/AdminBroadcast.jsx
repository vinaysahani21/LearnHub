...
const AdminBroadcast = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:5000/api/admin/broadcast', formData, config);
  ...
  const fetchHistory = async () => {
    try {
      ...
      const res = await axios.get('http://localhost:5000/api/admin/broadcast-history', config);
